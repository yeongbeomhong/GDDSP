...
#AUDIO_N_SAMPLES = AUDIO_SAMPLE_RATE * AUDIO_WINDOW_LENGTH  # Set Windowing hop=44200, Window len =44200, to prevent overlapping between frames from multiple audios.
