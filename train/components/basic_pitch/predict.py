...
def main() -> None:
    ...
    from basic_pitch.inference_not_use_path import predict_and_save, verify_output_dir, verify_input_path

    output_dir = pathlib.Path(args.output_dir)
    verify_output_dir(output_dir)

    audio_input_batch = [pathlib.Path(audio_path) for audio_path in args.audio_paths]
